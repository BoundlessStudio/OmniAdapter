...
public sealed class InputFunction
{
  ...
  /// </param>
  public InputFunction(string name, string description, string parameters)
  {
  ...
  internal InputFunction(InputFunction other) => CopyFrom(other);
  ...
  internal void CopyFrom(InputFunction other)
  {
